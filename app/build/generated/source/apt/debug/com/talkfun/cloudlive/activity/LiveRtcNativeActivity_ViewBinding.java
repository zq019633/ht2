...
public class LiveRtcNativeActivity_ViewBinding implements Unbinder {
  private LiveRtcNativeActivity target;
  ...
  @UiThread
  public LiveRtcNativeActivity_ViewBinding(LiveRtcNativeActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public LiveRtcNativeActivity_ViewBinding(final LiveRtcNativeActivity target, View source) {
    this.target = target;
    ...
    view = Utils.findRequiredView(source, R.id.chat_iv, "field 'chatIV' and method 'onClick'");
    target.chatIV = view;
    view2131296366 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
  ...
  @CallSuper
  public void unbind() {
    LiveRtcNativeActivity target = this.target;
