...
public class GlideImageLoader {
    ...
    public void load(int resId) {
        load(resId2Uri(resId));
    }

    public void load(Uri uri) {
        if (uri == null || getContext() == null) return;
        requestBuilder(uri).into(getImageView());
    }

    public void load(String url) {
        if (url == null || getContext() == null) return;
        requestBuilder(url).into(getImageView());
    }

    public DrawableRequestBuilder<Object> requestBuilder(Object obj) {
        ...
        return Glide.with(getContext())
                ...
                .listener(new RequestListener<Object, GlideDrawable>() {
                    ...
                    public boolean onException(Exception e, Object model, Target<GlideDrawable> target, boolean isFirstResource) {
                        if (onProgressListener == null && onGlideImageViewListener == null) {
                            return false;
                        }
