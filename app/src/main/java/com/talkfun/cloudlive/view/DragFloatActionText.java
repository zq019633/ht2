...
public class DragFloatActionText extends androidx.appcompat.widget.AppCompatTextView {
    ...
    public DragFloatActionText(Context context) {
        this(context, null);
    }

    public DragFloatActionText(Context context, AttributeSet attrs) {
        this(context, attrs, 0);

    }

    public DragFloatActionText(Context context, AttributeSet attrs, int defStyleAttr) {
