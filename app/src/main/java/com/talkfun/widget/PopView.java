...
/**
 * Created by ccy on 2018/4/25/23:40
 * author
 */
public class PopView implements PopupWindow.OnDismissListener {
    ...
    public <T extends PopView> T createPopup() {
    ...
    public <T extends PopView> T setContentView(View contentView) {
        this.mContentView = contentView;
        this.mLayoutId = 0;
        return (T) this;
    }

    public <T extends PopView> T setContentView(@LayoutRes int layoutId) {
        this.mContentView = null;
        this.mLayoutId = layoutId;
        return (T) this;
    }

    public <T extends PopView> T setContentView(View contentView, int width, int height) {
        this.mContentView = contentView;
        this.mLayoutId = 0;
        this.mWidth = width;
        this.mHeight = height;
    ...
    public <T extends PopView> T setContentView(@LayoutRes int layoutId, int width, int height) {
        this.mContentView = null;
        this.mLayoutId = layoutId;
        this.mWidth = width;
        this.mHeight = height;
    ...
    public <T extends PopView> T setWidth(int width) {
        this.mWidth = width;
        return (T) this;
    }

    public <T extends PopView> T setHeight(int height) {
        this.mHeight = height;
        return (T) this;
    }

    public <T extends PopView> T setAnchorView(View view) {
        this.mAnchorView = view;
        return (T) this;
    }

    public <T extends PopView> T setVerticalGravity(@VerticalGravity int verticalGravity) {
        this.mVerticalGravity = verticalGravity;
        return (T) this;
    }

    public <T extends PopView> T setHorizontalGravity(@VerticalGravity int horizontalGravity) {
        this.mHorizontalGravity = horizontalGravity;
        return (T) this;
    }

    public <T extends PopView> T setOffsetX(int offsetX) {
        this.mOffsetX = offsetX;
        return (T) this;
    }

    public <T extends PopView> T setOffsetY(int offsetY) {
        this.mOffsetY = offsetY;
        return (T) this;
    }

    public <T extends PopView> T setAnimationStyle(@StyleRes int animationStyle) {
        this.mAnimationStyle = animationStyle;
        return (T) this;
    }

    public <T extends PopView> T setFocusable(boolean focusable) {
        this.mFocusable = focusable;
        return (T) this;
    }

    public <T extends PopView> T setOutsideTouchable(boolean outsideTouchable) {
     ...
     * @return
     */
    public <T extends PopView> T setFocusAndOutsideEnable(boolean focusAndOutsideEnable) {
     ...
     * @return
     */
    public <T extends PopView> T setBackgroundDimEnable(boolean isDim) {
        this.isBackgroundDim = isDim;
        return (T) this;
    }

    public <T extends PopView> T setDimValue(@FloatRange(from = 0.0f, to = 1.0f) float dimValue) {
        this.mDimValue = dimValue;
        return (T) this;
    }

    public <T extends PopView> T setDimColor(@ColorInt int color) {
        this.mDimColor = color;
        return (T) this;
    }

    public <T extends PopView> T setDimView(@NonNull ViewGroup dimView) {
        this.mDimView = dimView;
        return (T) this;
    }

    @RequiresApi(api = Build.VERSION_CODES.M)
    public <T extends PopView> T setEnterTransition(Transition enterTransition) {
        this.mEnterTransition = enterTransition;
        return (T) this;
    }

    @RequiresApi(api = Build.VERSION_CODES.M)
    public <T extends PopView> T setExitTransition(Transition exitTransition) {
        this.mExitTransition = exitTransition;
        return (T) this;
    }

    public <T extends PopView> T setSoftInputMode(int mode) {
        this.mode = mode;
        return (T) this;
    }
...
//        Log.i(TAG, "updateLocation: x=" + measuredW + ",y=" + measuredH);
    ...
    private final ViewTreeObserver.OnGlobalLayoutListener mOnGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
        ...
        public void onGlobalLayout() {
            ...
            if (mOnAttachedWindowListener != null) {
                mOnAttachedWindowListener.onAttachedWindow(mWidth, mHeight, PopView.this);
            }
            //只获取宽高时，不执行更新操作
            if (isOnlyGetWH) {
     ...
     * @param listener
     */
    public <T extends PopView> T setOnDismissListener(PopupWindow.OnDismissListener listener) {
        this.mOnDismissListener = listener;
        return (T) this;
    }

    public <T extends PopView> T setOnAttachedWindowListener(OnAttachedWindowListener listener) {
...
//        ViewGroup parent = (ViewGroup) parent1.getChildAt(0);
    ...
    public interface OnAttachedWindowListener {
         ...
         * @param easyPop
         */
        void onAttachedWindow(int width, int height, PopView easyPop);
    }
